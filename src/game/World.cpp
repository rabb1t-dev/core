...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfig(CONFIG_BOOL_REST_ALWAYS_FULL,                     "Rest.AlwaysFull", false);
    setConfig(CONFIG_BOOL_HARNESS_ENABLE,                       "Harness.Enable", false);
    ...
    setConfig(CONFIG_UINT32_INTERVAL_SAVE_PROGRESS, "PlayerSave.ProgressDelay", 30 * IN_MILLISECONDS);
