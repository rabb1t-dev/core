...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_INTERVAL_SAVE_PROGRESS,
    ...
    CONFIG_UINT32_PARTY_BOT_DEATH_RECOVERY_TIMEOUT,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_PARTY_BOT_AUTO_REVIVE,
    ...
    CONFIG_BOOL_REST_ALWAYS_FULL,
    CONFIG_BOOL_HARNESS_ENABLE,
    CONFIG_BOOL_PARTY_BOT_COMBAT_LOG,
